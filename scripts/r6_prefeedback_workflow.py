#!/usr/bin/env python3
"""Run and validate the R6 pre-feedback positive-need exploration."""
...
from src.experiments.r6_prefeedback_positive_need import (  # noqa: E402
...
SCHEMA_VERSION = 2
MANIFEST_NAME = "r6_prefeedback_manifest.json"
PROGRESS_NAME = "r6_prefeedback_progress.json"
ARTIFACT_INDEX_NAME = "r6_prefeedback_artifact_index.json"
VALIDATION_NAME = "r6_prefeedback_validation.json"
COMPLETION_NAME = "COMPLETED.json"
CANDIDATE_POINTER_NAME = "CANDIDATE.json"
CURRENT_POINTER_NAME = "CURRENT.json"
IMPLEMENTATION_SOURCES = (
    "configs/r6_prefeedback_positive_need.json",
    "scripts/r6_prefeedback_workflow.py",
    "scripts/submit_hoffman2_r6_prefeedback.sh",
    "scripts/r6_scheduler.sh",
    "src/experiments/r6_prefeedback_positive_need.py",
...
def _validate_episode_domains(
    ...
    for row in rows:
        if row["round_classification"] != ROUND_LABEL:
            raise RuntimeError("round classification mismatch")
