#!/usr/bin/env python3
"""Run the R6 quadrature screening suite as 90 isolated array tasks."""
...
from scripts.r6_prefeedback_workflow import (  # noqa: E402
...
MANIFEST_NAME = "r6_quadrature_diagnostic_manifest.json"
SHARD_NAME = "quadrature_case.json"
PROVISIONAL_RESULT_NAME = "r6_quadrature_diagnostic_provisional.json"
FINAL_RESULT_NAME = "r6_quadrature_diagnostic_final.json"
...
DIAGNOSTIC_SOURCES = tuple(
    sorted(
        {
            *IMPLEMENTATION_SOURCES,
            "scripts/r6_quadrature_array.py",
            "scripts/submit_hoffman2_r6_quadrature_array.sh",
        }
    )
)
