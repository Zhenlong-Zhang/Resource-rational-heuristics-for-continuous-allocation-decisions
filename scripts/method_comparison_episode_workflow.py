...
WORKFLOW = "method_comparison_episode_array"
MANIFEST_FILENAME = "method_comparison_episode_array_manifest.json"
MANIFEST_HASH_FILENAME = "method_comparison_episode_array_manifest.sha256"
SCHEDULER_FILENAME = "method_comparison_episode_array_scheduler.json"
SUBMISSION_JOURNAL_FILENAME = "method_comparison_episode_array_submission.json"
PROGRESS_FILENAME = "method_comparison_episode_array_progress.json"
...
COMPLETION_MARKER = "METHOD_COMPARISON_EPISODE_ARRAY_COMPLETE"
...
def freeze_checkpoint(
    *,
    ...
    frozen_manifest_path = input_dir / "method_comparison_approx_methods_tasks.tsv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Freeze, shard, validate, stage, and promote MethodComparison method episodes."
    )
