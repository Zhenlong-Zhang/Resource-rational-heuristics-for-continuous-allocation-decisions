...
# Submit the baseline experiments Hoffman2 jobs used for targeted regime search and
...
submit_regime_job \
  ...
  "32" \
  "results/baseline_experiment_equal_outcome_distinct_serious"
...
submit_regime_job \
  ...
  "near_50_50" \
  "64" \
  "results/baseline_experiment_full_near_50_50_serious"
...
submit_regime_job \
  ...
  "equal_outcome" \
  "64" \
  "results/baseline_experiment_full_equal_outcome_serious"
...
submit_regime_job \
  ...
  "near_50_50_focused" \
  "36" \
  "results/baseline_experiment_confirm_near_50_50_focused_1200"
...
submit_regime_job \
  ...
  "48" \
  "results/baseline_experiment_confirm_equal_outcome_focused_1200"
...
submit_regime_job \
  ...
  "equal_outcome_distinct_focused" \
  "64" \
  "results/baseline_experiment_confirm_equal_outcome_distinct_1200"

echo
echo "Submitted baseline experiments Hoffman2 jobs. Check status with:"
echo "  qstat -u \${USER}"
