"""Test purpose: validate the manual active-search versus equal-split diagnostic criteria."""
...
class ActiveSearchDiagnosticRegressionTest(unittest.TestCase):
    ...
    def test_diagnostic_active_search_manual_advantage_candidate_selection(self) -> None:
        base = {
        ...
        candidates = identify_active_search_manual_advantage_candidates(rows)
