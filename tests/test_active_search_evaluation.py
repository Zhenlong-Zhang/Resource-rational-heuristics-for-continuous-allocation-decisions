"""Test purpose: validate active-search objective, information-value, confirmation, and solver metrics."""
...
from scripts.analyze_active_search import (
...
from scripts.active_search_evaluation_workflow import configs_from_json, parse_sample_budgets, rr_policy_from_manifest
from src.experiments.diagnostics import summarize_active_search_diagnostic_policies
from src.experiments.active_search_evaluation import (
    deterministic_realized_utility,
    evaluation_episode_fingerprint,
    evaluate_active_search_rr_environment,
    evaluate_active_search_fixed_sampling_budgets,
    full_information_oracle_metrics,
    full_information_utilitarian_allocation,
    summarize_active_search_fixed_sampling_budgets,
    wilson_interval,
)
...
from src.experiments.sweeps import build_active_search_six_sample_configs
...
class ActiveSearchDiagnosticsTests(unittest.TestCase):
    ...
    def test_rr_environment_releases_completed_observation_streams(self) -> None:
        from src.experiments import active_search_evaluation as active_search_module

        original_builder = active_search_module.build_evaluation_episode
        episode_refs = []
        live_before_build = []
        ...
        with patch.object(active_search_module, "build_evaluation_episode", side_effect=tracked_builder):
            rows = evaluate_active_search_rr_environment(
                "streaming_test",
                config,
                n_episodes=3,
    ...
    def test_six_sample_grid_contains_oracle_center_and_cost_limits(self) -> None:
        configs = [config for _, config in build_active_search_six_sample_configs()]
    ...
    def test_fixed_budget_curve_uses_common_episodes_and_exact_budgets(self) -> None:
        ...
        rows = evaluate_active_search_fixed_sampling_budgets(
            "fixture",
            config,
            n_episodes=3,
        ...
        summaries = summarize_active_search_fixed_sampling_budgets(rows)
    ...
    def test_formal_summary_recovers_frozen_anchor_and_feature_identity(self) -> None:
        ...
        summary = {
            ...
            "active_search_joint_discovery_candidate": 1.0,
        }
        ...
        self.assertEqual(rows[1]["active_search_joint_0_8_0_8"], 1.0)
    ...
    def test_diagnostic_active_search_summary_uses_mean_absolute_not_absolute_mean(self) -> None:
        common = {
            "environment": "fixture",
            "regime_grid": "fixture",
            "grid_index": 0.0,
        ...
        summary = summarize_active_search_diagnostic_policies(rows)[0]
    ...
    def test_active_search_manifest_builds_frozen_gauss_hermite_dp(self) -> None:
        manifest = {
    ...
    def test_active_search_episode_fingerprint_changes_with_observation_stream(self) -> None:
