...
from scripts.r6_prefeedback_workflow import (
    MANIFEST_NAME,
    ARTIFACT_INDEX_NAME,
    VALIDATION_NAME,
    collect,
...
"""
    ...
    @patch("scripts.r6_prefeedback_workflow.validate_source_identity")
    @patch("scripts.r6_prefeedback_workflow.platform.system", return_value="Linux")
    ...
    @patch("scripts.r6_prefeedback_workflow.validate_source_identity")
    @patch("scripts.r6_prefeedback_workflow.validate_qacct_evidence")
    @patch("scripts.r6_prefeedback_workflow.validate_collected_semantics")
    @patch("scripts.r6_prefeedback_workflow.validate_scheduler_task_bindings")
    @patch("scripts.r6_prefeedback_workflow.validate_scheduler_evidence", return_value={})
    @patch("scripts.r6_prefeedback_workflow.progress", return_value={"complete": True})
    @patch("scripts.r6_prefeedback_workflow.platform.node", return_value="local-mac")
    @patch("scripts.r6_prefeedback_workflow.platform.system", return_value="Darwin")
    def test_confirmation_local_readback_promotes_validated_version(
        ...
        with TemporaryDirectory() as temporary:
            ...
            with patch(
                "scripts.r6_prefeedback_workflow.load_manifest",
                return_value=manifest,
            ), patch(
                "scripts.r6_prefeedback_workflow.load_version_pointer",
    ...
    @patch("scripts.r6_prefeedback_workflow.validate_source_identity")
    @patch("scripts.r6_prefeedback_workflow.validate_numerical_case")
